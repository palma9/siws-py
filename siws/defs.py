DOMAIN = "(?P<domain>([^/?#]+)) wants you to sign in with your Stacks account:\\n"
...
REGEX_MESSAGE = f"^{DOMAIN}{ADDRESS}{STATEMENT}{URI_LINE}{NONCE}{ISSUED_AT}{EXPIRATION_TIME}{NOT_BEFORE}{REQUEST_ID}{RESOURCES}$"
